 ...
 */
@Autonomous(name = "Throw Far Blue")
public class ThrowFarBlue extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        robot.drive.driveAuto(0, 1.3, 1500);
        robot.drive.rotateClockwiseAuto(Math.PI/4, 1);
