...
/**
 * Created by fello on 3/12/2017.
 */
@Autonomous(name = "v2 Beacon Both Red")
public class BeaconBothRed2 extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        robot.drive.driveAuto(-1, -1, robot.drive.speedFast);
        ...
        robot.drive.driveAuto(0.07, 0, robot.drive.speedSlow);
        ...
        if (robot.colorSensor.red() > robot.colorSensor.blue()) {
            ...
            sleep(200);
            robot.drive.driveAuto(0, 0.20, robot.drive.speedSlow);
            sleep(200);
